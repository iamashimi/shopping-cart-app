...
/*
  method: GET
  respond arguments: title, products, successfull message, error
*/
...
/*
  method: GET
  get values by id (request arguments : id)
*/
...
/*
  method: GET
  reduce values by id (request arguments : id)
*/
...
/*
  method: GET
  remove values by id (request arguments : id)
*/
...
/*
  method: GET
  respond arguments: products, total price
*/
...
router.post("/checkout", isLoggedIn, function (req, res, next) {
  ...
  var mailOptions = {
    ...
    html:
      "<div ><div >INVOICE TO:</div><h2 >" +
      req.body.name +
      "</h2><div >" +
      req.body.address +
      "</div><div >" +
      req.user.email +
      "</div></div><div><h2 >INVOICE</h2><div >Total Price: $" +
      total +
      "</div><div >Card Holder: " +
      req.body.cardname +
      "</div><div >Card Number: " +
      req.body.cardnumber +
      "</div><div >Date of Invoice: " +
      Date() +
      "</div></div></div><br/><div><b>Thank you!</b></div>",
  };
  ...
  var cart = new Cart(req.session.cart);
  var stripe = require("stripe")("sk_test_n03wpz24VOmltiZGXHcy6m0r00DzVQyj2H");
...
router.get("/cashOnDelivery", isLoggedIn, function (req, res, next) {
  ...
  var cart = new Cart(req.session.cart);
  var errMsg = req.flash("error")[0];
  res.render("shop/cashOnDelivery", {
    total: cart.totalPrice,
    errMsg: errMsg,
    noError: !errMsg,
  });
...
router.post("/cashOnDelivery", isLoggedIn, function (req, res, next) {
  ...
  var mailOptions = {
    ...
    html:
      ...
      "</div><div >" +
      req.user.email +
      "</div></div><div><h2 >INVOICE</h2><h2 >You should pay when the packeage is delivered </h2><div >Total Price: $" +
      total +
      "</div><div > " +
      Date() +
      "</div></div></div><br/><div><b>Thank you!</b></div>",
...
/*
  method: GET
  response arguments: products, total price
*/
